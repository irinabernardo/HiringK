...
const SQL_INSERT = 'INSERT INTO Job (CategoryId, JobName, JobDescription, Start_Date, Finish_Date) VALUES (@categoryId, @JobName, @JobDescription, @Start_Date, @Finish_Date); SELECT * from dbo.Job WHERE JobId = SCOPE_IDENTITY();';
